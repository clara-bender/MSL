...
# If this file exists, any command about to be sent to the robot is skipped instead
STOP_FLAG_PATH = "stop_robot.flag"
...
def interpolate_action(state, goal):
    ...
    for i in range(int(DT * CONTROL_HZ)):
        ...
        if not debug and robot_active and not os.path.exists(STOP_FLAG_PATH):
